  ...
  return (
    <div className={styles.container}>
      ...
      <form onSubmit={handleSubmit} className={styles.form}>
        ...
        <button type="button" onClick={handleAddMetadata} className={styles.button}>+ Adicionar Metadado</button>
        <input type="file" onChange={handleFileChange} className={styles.fileInput} />
        <button type="submit" disabled={loading} className={styles.button}>{loading ? "Salvando..." : "Adicionar Música"}</button>
      </form>
    </div>
  );
}
